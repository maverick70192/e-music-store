...
<div class="conatiner-wrapper">
	<div class="container">
		...
		<sf:form modelAttribute="product" method="post" enctype="multipart/form-data">
			...
			<sf:hidden path="imageName" value="${ product.imageName }"/>
			...
			<div class="form-group">
				...
				<sf:input type="file" name="${ product.imageName }" path="image" accept="image/*" cssErrorClass="error" class="form-control" />			
			</div>
			<br/>
